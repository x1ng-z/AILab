...
<div style="position: absolute;left: 0;top: 0;width: 100%;height:100%;overflow: auto;overflow-x: hidden">
                    ...
                    <c:forEach var="pv" items="${modle.categoryPVmodletag}" begin="4" varStatus="Count">
                        <div class="layui-col-md4">
                            <div class="layui-card">
                                <div class="layui-card-header">${pv.modlePinName}(${pv.modleOpcTag})</div>
                                <div class="layui-card-body">
                                    <div id="container${Count.count}" pinname="${pv.modlePinName}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-btn-group">
            ...
            <a href=""
               class="layui-btn" onclick="newTab('编辑${modle.modleName}','${pageContext.request.contextPath}/modle/modifymodle.do?modleid=${modle.modleId}')">编辑</a>


            <c:choose>
                <c:when test="${modle.modleEnable eq 1}">
                    <a href=""
                       class="layui-btn" onclick="stopOrrun('${pageContext.request.contextPath}/modle/stopModle.do?modleid=${modle.modleId}','确定停止？')">停止</a>
                </c:when>
                <c:otherwise>
                    <a href=""
                       class="layui-btn" onclick="stopOrrun('${pageContext.request.contextPath}/modle/runModle.do?modleid=${modle.modleId}','确定运行？')">运行</a>
                </c:otherwise>
            </c:choose>
        </div>
    ...
    <script type="text/html" id="switchTpl1">
        <input type="checkbox" disabled name="auto" value="{{d.auto}}" lay-skin="switch" lay-text="自动|手动" lay-filter="sexDemo" {{ d.auto === "自动" ? 'checked' : '' }}/>
    </script>
<script>
...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , "cols": [[
                {field: 'modleName', title: '模块名称', sort: true}
