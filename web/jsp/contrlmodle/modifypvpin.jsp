...
<form class="layui-form" action="" method="post">
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="modleid" value="${pvpin.reference_modleId}"  autocomplete="off" class="layui-input"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">



                    <input type="text" name="pvpinid" autocomplete="off" class="layui-input" value="${pvpin.modlepinsId}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                                ...
                                <c:forEach var="pinindex" items="${unuserpinscope}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${Count.count==1}">
                                            <option value="${pintype}${pinindex}" selected>${pintype}${pinindex}</option>
                                        </c:when>
                                        <c:otherwise>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="pvDeadZone" autocomplete="off" lay-verify="required"
                                   class="layui-input" placeholder="pv的死区" value="${pvpin.deadZone}" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="pvFunelInitValue" autocomplete="off" lay-verify="required"
                                   class="layui-input" placeholder="pv的漏斗值" value="${pvpin.funelinitValue}"  onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="tracoef" autocomplete="off" class="layui-input" lay-verify="required"
                                   placeholder="pv的柔化系数"  value="${pvpin.referTrajectoryCoef}" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="pvuppinid" autocomplete="off" class="layui-input" value="${pvuppin.modlepinsId}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <input type="text" name="pvdownpinid" autocomplete="off" class="layui-input" value="${pvdownpin.modlepinsId}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <input name="pinfilterid" value="${pvpin.filter.pk_filterid}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="filtercoefpv" autocomplete="off"
                                   class="layui-input" placeholder="pv滤波系数" value="${pvpin.filter.getcoeff()}" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="pvenableid" autocomplete="off" class="layui-input" value="${pvpinenable.modlepinsId}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="shockerid" autocomplete="off" class="layui-input" value="${pvpin.shockDetector.pk_shockdetectid}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="detectwindowstimepv" autocomplete="off"
                                   class="layui-input"
                                   placeholder="pv震荡监视时间" onmousewheel='scrollFunc()' value="${pvpin.shockDetector.windowstime}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="detectdampcoepv" autocomplete="off"
                                   class="layui-input"
                                   placeholder="pv阻尼系数" onmousewheel='scrollFunc()' value="${pvpin.shockDetector.dampcoeff}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="detectfiltercoepv" autocomplete="off"
                                   class="layui-input"
                                   placeholder="pv滤波系数" onmousewheel='scrollFunc()' value="${pvpin.shockDetector.filtercoeff}">
                        </div>
                    </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="sppinid" autocomplete="off" class="layui-input" value="${sppin.modlepinsId}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
    ...
    <div class="layui-input-block">
        <button type="submit" class="layui-btn" lay-submit="" id="modifycontrlmodlepinsubmitbt" lay-filter="newcontrlmodlepinsubmit"
