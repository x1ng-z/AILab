    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="tagName" autocomplete="off" class="layui-input" placeholder="位号注释" value="${opcvertag.tagName}">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">位号</label>
            <div class="layui-input-inline">
                <input type="text" name="tag" lay-verify="required" autocomplete="off" class="layui-input" value="${opcvertag.tag}"
                       placeholder="opc位号">
            </div>
        </div>
        ...
        <div class="layui-inline" style="visibility: hidden">
            <div class="layui-input-inline">
                <input type="text" name="opcserveid" autocomplete="off" class="layui-input" value="${opcvertag.opcserveid}"
        ...
        <div class="layui-inline" style="visibility: hidden">
            <div class="layui-input-inline">
                <div class="layui-input-inline">
                    <input type="text" name="tagid" autocomplete="off" class="layui-input" value="${opcvertag.tagid}">
                </div>
            </div>
        </div>
        ...
        <div class="layui-input-block">
            <div class="layui-row">
                ...
                <div class="layui-col-md6">
                    <button type="submit" class="layui-btn" lay-submit="" lay-filter="modifyopcservevertagsb" id="opcservevertagsubmit"
...
<script>
    layui.use(['form'], function () {
        ...
        //     }
        // );
        form.on('submit(modifyopcservevertagsb)', function (data) {
            console.log(JSON.stringify(data.field));

            var index = layer.msg('创建中，请稍候', {icon: 16, time: false, shade: 0.8});

            $.ajax({
                url: "${pageContext.request.contextPath}/opc/savemodifyopcservevertag.do" + "?" + Math.random(),
                async: true,
                data: {
                ...
                success: function (result) {
                    ...
                    if (json['msg'] == "error") {
                        ...
                        layer.msg("创建成功！");
                        successAndClosemodifyopcvertagWD();
